...
import { MdVerified, MdPending, MdCancel, MdCheckCircle, MdWarning } from 'react-icons/md';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        {/* Description */}
                        <div className={`bg-white rounded-xl shadow-sm p-6 border ${isRejected ? 'border-red-200' : isApproved ? 'border-green-200' : 'border-gray-100'}`}>
                    ...
                    <div className="space-y-6">
                        {/* Property Info Card */}
                        <div className={`bg-white rounded-xl shadow-sm p-6 border ${isRejected ? 'border-red-200' : isApproved ? 'border-green-200' : 'border-gray-100'} sticky top-24`}>
                                    ...
                                    {isRejected ? (
                                        ...
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="w-full py-3 bg-white text-blue-600 font-semibold rounded-lg border-2 border-blue-600 hover:bg-blue-50 transition-colors"
                                            >
                                                Schedule Viewing
                                            </button>
                                            <button
